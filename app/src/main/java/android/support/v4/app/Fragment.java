...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public void setUserVisibleHint(boolean z) {
        if (!this.mUserVisibleHint && z && this.mState < 4 && this.mFragmentManager != null) {
    ...
    void instantiateChildFragmentManager() {
        ...
        Log.d("zyc", getClass().getSimpleName() + ".instantiateChildFragmentManager  " + "mActivity: " + this.mActivity + " fragment:" + getClass() + " mState: " + this.mState + " getParentFragment" + getParentFragment());
        if (this.mActivity == null) {
            Writer stringWriter = new StringWriter();
            new Exception("instantiateChildFragmentManager").printStackTrace(new PrintWriter(stringWriter));
            FragmentManagerImpl.setException(stringWriter.toString());
        }
    ...
    void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            ...
            Log.d("zyc", getClass().getSimpleName() + ".performActivityCreated---> " + getClass());
            this.mChildFragmentManager.dispatchActivityCreated();
        }
    }
