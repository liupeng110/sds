...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mIndicatorHeight = (int) ((3.0f * f) + TTFMImageUtils.Middle_Scale);
        this.mMinPaddingBottom = (int) ((6.0f * f) + TTFMImageUtils.Middle_Scale);
        this.mMinTextSpacing = (int) (64.0f * f);
        this.mTabPadding = (int) ((16.0f * f) + TTFMImageUtils.Middle_Scale);
        this.mFullUnderlineHeight = (int) ((1.0f * f) + TTFMImageUtils.Middle_Scale);
        this.mMinStripHeight = (int) ((f * 32.0f) + TTFMImageUtils.Middle_Scale);
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        this.mTabAlpha = (int) ((Math.abs(f - TTFMImageUtils.Middle_Scale) * 2.0f) * 255.0f);
