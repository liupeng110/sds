...
public class FileProvider extends ContentProvider {
    ...
    private static final String[] COLUMNS = new String[]{MediasColumns.DISPLAY_NAME, MediasColumns.SIZE};
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        while (i < length) {
            int i3;
            Object obj = strArr[i];
            if (MediasColumns.DISPLAY_NAME.equals(obj)) {
                strArr3[i2] = MediasColumns.DISPLAY_NAME;
                i3 = i2 + 1;
                objArr[i2] = fileForUri.getName();
            } else if (MediasColumns.SIZE.equals(obj)) {
                strArr3[i2] = MediasColumns.SIZE;
                i3 = i2 + 1;
