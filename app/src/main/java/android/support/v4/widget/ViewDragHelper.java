...
public class ViewDragHelper {
    ...
    private ViewDragHelper(Context context, ViewGroup viewGroup, Callback callback) {
        if (viewGroup == null) {
            ...
            this.mEdgeSize = (int) ((context.getResources().getDisplayMetrics().density * TitleBar.BACKBTN_LEFT_MARGIN) + TTFMImageUtils.Middle_Scale);
    ...
    private boolean checkNewEdgeDrag(float f, float f2, int i, int i2) {
        ...
        if (abs < abs2 * TTFMImageUtils.Middle_Scale && this.mCallback.onEdgeLock(i2)) {
