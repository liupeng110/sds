...
public abstract class AutoScrollHelper implements OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        public void start() {
            ...
            this.mStopValue = TTFMImageUtils.Middle_Scale;
            this.mDeltaX = 0;
            this.mDeltaY = 0;
        }
        ...
        private float getValueAt(long j) {
            ...
            if (this.mStopTime < 0 || j < this.mStopTime) {
                return AutoScrollHelper.constrain(((float) (j - this.mStartTime)) / ((float) this.mRampUpDuration), 0.0f, (float) AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY) * TTFMImageUtils.Middle_Scale;
            }
    ...
    public AutoScrollHelper(View view) {
        ...
        int i = (int) ((1575.0f * displayMetrics.density) + TTFMImageUtils.Middle_Scale);
        int i2 = (int) ((displayMetrics.density * 315.0f) + TTFMImageUtils.Middle_Scale);
