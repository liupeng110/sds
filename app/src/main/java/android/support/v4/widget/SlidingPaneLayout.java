...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private class DragHelperCallback extends Callback {
        ...
        public void onViewReleased(View view, float f, float f2) {
            ...
            if (f > 0.0f || (f == 0.0f && SlidingPaneLayout.this.mSlideOffset > TTFMImageUtils.Middle_Scale)) {
    ...
    public SlidingPaneLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mOverhangSize = (int) ((32.0f * f) + TTFMImageUtils.Middle_Scale);
        ViewConfiguration.get(context);
        setWillNotDraw(false);
        ViewCompat.setAccessibilityDelegate(this, new AccessibilityDelegate());
        ViewCompat.setImportantForAccessibility(this, 1);
        this.mDragHelper = ViewDragHelper.create(this, TTFMImageUtils.Middle_Scale, new DragHelperCallback());
    ...
    protected void onMeasure(int i, int i2) {
        ...
        } else if (mode == ExploreByTouchHelper.INVALID_ID) {
            i3 = mode2;
            i4 = size;
            size = size2;
        } else {
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.height == -2) {
                    i7 = MeasureSpec.makeMeasureSpec(mode2, ExploreByTouchHelper.INVALID_ID);
                        ...
                        if (!z || childAt2 == this.mSlideableView) {
                            if (layoutParams.weight > 0.0f) {
                                ...
                                if (z) {
                                    ...
                                    childAt2.measure(MeasureSpec.makeMeasureSpec(((int) ((layoutParams.weight * ((float) Math.max(0, paddingLeft))) / f)) + i7, 1073741824), mode);
                                }
                            }
