...
class d {
    ...
    private static char[] if = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/.".toCharArray();
    ...
    private static char[] if(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            ...
            cArr[i + 3] = if[obj2 != null ? 63 - (i3 & 63) : 64];
            int i4 = i3 >> 6;
            cArr[i + 2] = if[obj != null ? 63 - (i4 & 63) : 64];
            i3 = i4 >> 6;
            cArr[i + 1] = if[63 - (i3 & 63)];
            cArr[i + 0] = if[63 - ((i3 >> 6) & 63)];
            i2 += 3;
            i += 4;
        }
        return cArr;
