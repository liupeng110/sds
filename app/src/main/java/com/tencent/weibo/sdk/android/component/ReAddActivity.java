...
public class ReAddActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (extras != null) {
            ...
            this.picPath = extras.getString(ScaleImageActivity.KEY_PIC_URL);
    ...
    public View initLayout() {
        ...
        relativeLayout2.setLayoutParams(new RelativeLayout.LayoutParams(-1, 240));
        ...
        layoutParams2 = new RelativeLayout.LayoutParams(SecExceptionCode.SEC_ERROR_STA_NO_DATA_FILE, SecExceptionCode.SEC_ERROR_STA_STORE_NO_DATA_FILE);
