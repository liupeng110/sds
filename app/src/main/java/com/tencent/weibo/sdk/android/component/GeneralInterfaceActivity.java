...
public class GeneralInterfaceActivity extends Activity implements OnClickListener {
    ...
    public void initInterface() {
        ...
        this.addPic.setId(VersionUpdateConst.UPDATE_TENCENT_TYPE);
        ...
        this.addPicUrl.setId(VersionUpdateConst.UPDATE_ANZHI_TYPE);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case VersionUpdateConst.UPDATE_ANZHI_TYPE /*1005*/:
                ...
                return;
            case 1006:
                this.timeLineAPI.getHTTimeLine(this.context, this.requestFormat, 30, FeedbackItem.STATUS_WAITING, FeedbackItem.STATUS_WAITING, 0, 0, "加油", FeedbackItem.STATUS_WAITING, 1, 128, this.mCallBack, null, 4);
                return;
            case 1007:
            ...
            case 1014:
                ...
                return;
            case 1015:
                this.weiboAPI.reList(this.context, this.requestFormat, 2, "112714089895346", 0, FeedbackItem.STATUS_WAITING, 30, FeedbackItem.STATUS_WAITING, this.mCallBack, null, 4);
                return;
            case 1016:
