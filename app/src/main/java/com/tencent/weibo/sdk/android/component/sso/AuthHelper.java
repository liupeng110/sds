...
public final class AuthHelper {
    ...
    private static int validateWeiboApp(Context context) {
        ...
        try {
            ...
            if (packageInfo == null || packageInfo.versionCode < SUPPORT_WEIBO_MIN_VERSION || packageManager.queryIntentActivities(new Intent("android.intent.action.VIEW", Uri.parse(WEIBO_AUTH_URL)), 65536).size() <= 0) {
                return -1;
            }
            return 0;
        } catch (NameNotFoundException e) {
