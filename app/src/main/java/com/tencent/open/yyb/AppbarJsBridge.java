...
public class AppbarJsBridge {
    ...
    public void closeWebView(Uri uri, int i, String str, String str2) {
        d.b("openSDK_LOG", "-->closeWebView : url = " + uri);
        this.b.finish();
    }

    public void pageControl(Uri uri, int i, String str, String str2) {
        d.b("openSDK_LOG", "-->pageControl : url = " + uri);
    ...
    public void share(Uri uri, int i, String str, String str2) {
        ...
        d.b("openSDK_LOG", "-->share : title = " + queryParameter);
        d.b("openSDK_LOG", "-->share : summary = " + queryParameter2);
        d.b("openSDK_LOG", "-->share : iconUrl = " + queryParameter3);
        d.b("openSDK_LOG", "-->share : jumpUrl = " + queryParameter4);
        ...
        switch (Util.parseIntValue(uri.getQueryParameter(SocialConstants.PARAM_TYPE), 0)) {
            case 1:
    ...
    public void getAppInfo(Uri uri, int i, String str, String str2) {
        ...
        d.b("openSDK_LOG", "-->getAppInfo : packageNames = " + queryParameter);
        if (!TextUtils.isEmpty(queryParameter) && !TextUtils.isEmpty(str2)) {
            String[] split = queryParameter.split(SelectCountryActivity.SPLITTER);
            if (split != null && split.length != 0) {
                ...
                d.b("openSDK_LOG", "-->getAppInfo : result = " + jSONObject.toString());
    ...
    public void setWebView(Uri uri, int i, String str, String str2) {
        ...
        try {
            ...
            d.b("openSDK_LOG", "-->setWebView : url = " + uri + " -- buttonVisiable = " + parseIntValue);
            response(str2, i, str, "");
        } catch (Exception e) {
            responseFail(str2, i, str, -3);
        }
    ...
    public void openLoginActivity(Uri uri, int i, String str, String str2) {
        d.b("openSDK_LOG", "-->openLoginActivity : url = " + uri);
    ...
    public void invoke(String str) {
        int i;
        d.b("openSDK_LOG", "-->invoke : url = " + str);
        Uri parse = Uri.parse(str);
        String host = parse.getHost();
        d.b("openSDK_LOG", "-->invoke : hostAsMethodName = " + host);
        if (!TextUtils.isEmpty(host)) {
            ...
            if (host.equals("callBatch")) {
                try {
                    JSONArray jSONArray = new JSONArray(parse.getQueryParameter(SService.STATISTIC_PARAM));
    ...
    private void a(Uri uri, String str, int i, String str2) {
        d.b("openSDK_LOG", "-->callAMethod : uri = " + uri);
        if (a(str)) {
            try {
                ...
                d.b("openSDK_LOG", "-->callAMethod : Exception = " + e.getMessage());
                e.printStackTrace();
                if (!TextUtils.isEmpty(str2)) {
                    responseFail(str2, i, str, -3);
                }
    ...
    public void responseShare(int i) {
        ...
        response(CALLBACK_SHARE, 0, null, FeedbackItem.STATUS_WAITING, hashMap);
    }
