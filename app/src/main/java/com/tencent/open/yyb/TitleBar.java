...
public class TitleBar extends RelativeLayout {
    ...
    public TitleBar(Context context) {
        ...
        setBackgroundDrawable(b.a(SOURCE_TITLEBAR, context));
        initBackLayout();
        initShareBtn();
    }
    ...
    private void initBackBtn() {
        ...
        this.backBtn.setBackgroundDrawable(b.a(SOURCE_BACK_BTN, getContext()));
    ...
    private void initShareBtn() {
        ...
        this.shareBtn.setBackgroundDrawable(b.a(SOURCE_MORE_BTN, getContext()));
