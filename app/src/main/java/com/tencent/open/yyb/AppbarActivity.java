...
public class AppbarActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        com.tencent.a.a.d.b("openSDK_LOG", "-->(AppbarActivity)onCreate : appid = " + this.appid + " url = " + this.url);
    ...
    public void login() {
        ...
        getTencent().login(this, "all", new IUiListener(this) {
            final /* synthetic */ AppbarActivity a;
            ...
            public void onComplete(Object obj) {
                ...
                try {
                    ...
                    b.a(this.a, this.a.mWebView.getUrl(), string, string2, this.a.getToken().getAppId());
    ...
    public void shareToQQ() {
        ...
        if (token != null) {
            ...
            com.tencent.a.a.d.b("openSDK_LOG", "-->(AppbarActivity)shareToQQ : model.mTitle = " + this.model.a);
            com.tencent.a.a.d.b("openSDK_LOG", "-->(AppbarActivity)shareToQQ : model.mTargetUrl = " + this.model.d);
            com.tencent.a.a.d.b("openSDK_LOG", "-->(AppbarActivity)shareToQQ : model.mDescription = " + this.model.b);
            com.tencent.a.a.d.b("openSDK_LOG", "-->(AppbarActivity)shareToQQ : model.mIconUrl = " + this.model.c);
            qQShare.shareToQQ(this, bundle, new IUiListener(this) {
                ...
                public void onComplete(Object obj) {
                    ...
                    b.a(token.getAppId(), "400", "SDK.APPBAR.HOME.SHARE.QQ");
                }
            ...
            b.a(token.getAppId(), "200", "SDK.APPBAR.HOME.SHARE.QQ");
        }
    }
    ...
    public void shareToQzone() {
        ...
        if (token != null) {
            ...
            com.tencent.a.a.d.b("openSDK_LOG", "-->shareToQzone : mIconUrl = " + this.model.c);
            ...
            qzoneShare.shareToQzone(this, bundle, new IUiListener(this) {
                ...
                public void onComplete(Object obj) {
                    ...
                    b.a(token.getAppId(), "400", "SDK.APPBAR.HOME.SHARE.QZ");
                }
            ...
            b.a(token.getAppId(), "200", "SDK.APPBAR.HOME.SHARE.QZ");
        }
    }
    ...
    private void shareToWX(boolean z) {
        com.tencent.a.a.d.b("openSDK_LOG", "-->shareToWX : wx_appid = " + AppbarAgent.wx_appid);
