...
public class MoreFloatingDialog extends Dialog {
    ...
    public MoreFloatingDialog(Context context) {
        ...
        this.mContentView.setBackgroundDrawable(b.a(SOURCE_FLOATING_BG, context, this.ninePatchRect));
        this.mRootView = new LinearLayout(context);
        layoutParams = new LinearLayout.LayoutParams(-1, -2);
        this.mRootView.setLayoutParams(layoutParams);
        this.mShareItems.put(SOURCE_QQ_BG, addShareItemText(b.a(SOURCE_QQ_BG, getContext(), this.ninePatchRect), "QQ分享"));
        this.mShareItems.put(SOURCE_QZONE_BG, addShareItemText(b.a(SOURCE_QZONE_BG, getContext(), this.ninePatchRect), "空间分享"));
    ...
    public int dip2px(float f) {
        return (int) ((this.density * f) + TTFMImageUtils.Middle_Scale);
    }
}
