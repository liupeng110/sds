...
public class c extends AsyncTask<Bitmap, Void, HashMap<String, Object>> {
    ...
    protected HashMap<String, Object> a(Bitmap... bitmapArr) {
        ...
        try {
            ...
            if (bitmap != null) {
                Object b;
                String str = "";
                if (bitmap.getWidth() > TTFMSongEntity.BITRATE_DEFAULT || bitmap.getHeight() > TTFMSongEntity.BITRATE_DEFAULT) {
                    Bitmap a = a(bitmap);
                    b = b(a);
                    a.recycle();
                } else {
    ...
    private Bitmap a(Bitmap bitmap) {
        ...
        int a = a(options, TTFMSongEntity.BITRATE_DEFAULT, TTFMSongEntity.BITRATE_DEFAULT);
        if (a > 0) {
            i = a;
        }
