...
public final class a {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        public boolean a(String str, String str2) {
            ...
            if (str2.charAt(4) != s.a.charAt(((((a * 9) + 10) / 3) + 36) & 31)) {
                return false;
            }
            if (str2.charAt(7) != s.a.charAt((((a * 5) + 11) / 5) & 31)) {
                return false;
            }
            if (str2.charAt(12) != s.a.charAt((((a + 10) / 3) << 3) & 31)) {
                return false;
            }
            if (str2.charAt(14) != s.a.charAt((((a * 3) + 19) / 9) & 31)) {
                return false;
            }
            if (str2.charAt(19) != s.a.charAt((((a * 3) + 39) / 8) & 31)) {
                return false;
            }
            if (str2.charAt(21) != s.a.charAt((((a / 23) + 67) / 7) & 31)) {
                return false;
            }
            if (str2.charAt(26) != s.a.charAt(((((a + 23) / 6) + 3) * 7) & 31)) {
                return false;
            }
            int i = 0;
            for (a = 0; a < str.length(); a++) {
                i = s.b[(i ^ s.a(str.charAt(a))) & MotionEventCompat.ACTION_MASK] ^ ((i >> 8) & MotionEventCompat.ACTION_MASK);
            }
            if (str2.charAt(0) != s.a.charAt(i & 31)) {
                return false;
            }
            return str2.charAt(1) == s.a.charAt((i >> 5) & 31);
        }
    }
...
*/
        ...
        r1 = 1;
        r0 = 0;
        r2 = com.tencent.map.b.s.a(r9);
        if (r2 != 0) goto L_0x000b;
    L_0x000a:
        return r0;
    L_0x000b:
        r2 = com.tencent.map.b.s.b(r10);
    ...
    L_0x0020:
        r4 = r3 >> 8;
        r4 = r4 & 255;
        r5 = com.tencent.map.b.s.b;
        r6 = r10.charAt(r2);
        r6 = com.tencent.map.b.s.a(r6);
        r3 = r3 ^ r6;
        r3 = r3 & 255;
        r3 = r5[r3];
        r3 = r3 ^ r4;
