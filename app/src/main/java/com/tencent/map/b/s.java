...
import com.tencent.map.b.e.a;
import com.tencent.map.b.f.b;
...
public final class s {
    ...
    private static String a(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        if (!(i6 == Entry.MAX_LIMIT || i7 == Entry.MAX_LIMIT)) {
    ...
    public static String a(a aVar) {
        ...
        stringBuilder.append("\"" + b.getAltitude() + SelectCountryActivity.SPLITTER + b.getAccuracy() + SelectCountryActivity.SPLITTER + b.getBearing() + SelectCountryActivity.SPLITTER + b.getSpeed() + SelectCountryActivity.SPLITTER + b.getTime() + "\"");
        stringBuilder.append("}");
        return stringBuilder.toString();
    }
    ...
    public static String a(m.b bVar, List<NeighboringCellInfo> list) {
        int i = 0;
        if (bVar == null) {
            return "[]";
        }
            ...
            try {
                ...
                for (NeighboringCellInfo neighboringCellInfo : list) {
                    ...
                    if (a(bVar.a, i2, i3, parseInt, neighboringCellInfo.getCid())) {
                        ...
                        stringBuilder.append(a(i2, i3, parseInt, neighboringCellInfo.getCid(), (neighboringCellInfo.getRssi() << 1) - 113, Entry.MAX_LIMIT, Entry.MAX_LIMIT));
                        parseInt = i + 1;
                    } else {
                        parseInt = i;
                    }
    ...
    public static boolean a(int i, int i2, int i3, int i4, int i5) {
        return i == 2 ? i2 >= 0 && i3 >= 0 && i4 >= 0 && i4 <= SupportMenu.USER_MASK && i5 >= 0 && i5 <= SupportMenu.USER_MASK && !(i3 == 0 && i4 == 0 && i5 == 0) : (i2 < 0 || i3 < 0 || i4 <= 0 || i4 >= SupportMenu.USER_MASK) ? false : (i5 == 268435455 || i5 == Entry.MAX_LIMIT || i5 == 50594049 || i5 == SupportMenu.USER_MASK || i5 == 8 || i5 == 10 || i5 == 33 || i5 <= 0) ? false : true;
    }
