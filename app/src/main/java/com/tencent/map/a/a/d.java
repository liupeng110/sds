...
public class d {
    ...
    public String toString() {
        ...
        if (this.z == 4 && this.w != null) {
            ...
            while (it.hasNext()) {
                c cVar = (c) it.next();
                stringBuilder.append(cVar.a).append(SelectCountryActivity.SPLITTER).append(cVar.b).append(SelectCountryActivity.SPLITTER).append(cVar.c).append(SelectCountryActivity.SPLITTER).append(cVar.d).append(SelectCountryActivity.SPLITTER).append(cVar.e).append(SelectCountryActivity.SPLITTER).append(cVar.f).append("\n");
            }
        }
        if (this.z == 7) {
            if (this.h == 0) {
