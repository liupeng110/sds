...
public class u {
    ...
    private void I() {
        ...
        Cursor query;
        try {
            query = this.bW.getReadableDatabase().query("config", null, null, null, null, null, null);
    ...
    private synchronized void a(com.tencent.wxop.stat.a.d r7, com.tencent.wxop.stat.ak r8, boolean r9, boolean r10) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.tencent.wxop.stat.u.a(com.tencent.wxop.stat.a.d, com.tencent.wxop.stat.ak, boolean, boolean):void. bs: [B:20:0x0092, B:51:0x00e9]
...
*/
    ...
    private synchronized void a(ai aiVar) {
        ...
        try {
            Object obj;
            long update;
            String jSONObject = aiVar.df.toString();
            ...
            } while (query.getInt(0) != aiVar.aI);
            obj = 1;
            this.bW.getWritableDatabase().beginTransaction();
            if (1 == obj) {
                update = (long) this.bW.getWritableDatabase().update("config", contentValues, "type=?", new String[]{Integer.toString(aiVar.aI)});
            } else {
                contentValues.put(SocialConstants.PARAM_TYPE, Integer.valueOf(aiVar.aI));
    ...
    static /* synthetic */ void a(u uVar, int i, boolean z) {
        int ak = i == -1 ? !z ? uVar.ak() : uVar.al() : i;
        if (ak > 0) {
            int u = (c.u() * 60) * c.q();
            if (ak > u && u > 0) {
                ak = u;
    ...
    private synchronized void a(List<ae> list, int i, boolean z) {
        SQLiteDatabase c;
        Throwable th;
        String str = null;
        synchronized (this) {
    ...
    private synchronized void a(java.util.List<com.tencent.wxop.stat.ae> r9, boolean r10) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.tencent.wxop.stat.u.a(java.util.List, boolean):void. bs: [B:26:0x00c1, B:49:0x00e9]
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:86)
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.process(ProcessTryCatchRegions.java:45)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.postProcessRegions(RegionMakerVisitor.java:63)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.visit(RegionMakerVisitor.java:58)
...
*/
    ...
    L_0x0052:
        ...
        r0 = (com.tencent.wxop.stat.ae) r0;	 Catch:{ all -> 0x00ce }
    ...
    L_0x00ed:
        ...
        goto L_0x00ec;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.wxop.stat.u.a(java.util.List, boolean):void");
    }
    ...
    private void am() {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.tencent.wxop.stat.u.am():void. bs: [B:42:0x011b, B:53:0x0133]
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:86)
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.process(ProcessTryCatchRegions.java:45)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.postProcessRegions(RegionMakerVisitor.java:63)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.visit(RegionMakerVisitor.java:58)
...
*/
    ...
    L_0x013a:
        ...
        goto L_0x0139;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.wxop.stat.u.am():void");
    }
    ...
    private void b(List<ae> list, int i, boolean z) {
        ...
        while (cursor2.moveToNext()) {
            try {
                ...
                ae aeVar = new ae(j, string, i2, i3);
                if (c.k()) {
                    bZ.b("peek event, id=" + j + ",send_count=" + i3 + ",timestamp=" + cursor2.getLong(4));
                }
                list.add(aeVar);
            } catch (Throwable th3) {
                th = th3;
    ...
    final void b(d dVar, ak akVar, boolean z, boolean z2) {
        if (this.be != null) {
            ...
            try {
                ...
                try {
                    ...
                    if (query.moveToNext()) {
                        ...
                        String[] split = t.split(SelectCountryActivity.SPLITTER);
                        obj = null;
                        ...
                        if (split == null || split.length < 2) {
                            ...
                            if (string != null && string.length() > 0) {
                                c = t + SelectCountryActivity.SPLITTER + string;
                                obj = 1;
                            }
                        } else {
                            string = split[1];
                        ...
                        ContentValues contentValues = new ContentValues();
                        contentValues.put(ParamKey.UID, r.q(c));
                    ...
                    if (obj == null) {
                        string = l.c(context);
                        c = l.w(context);
                        String str2 = (c == null || c.length() <= 0) ? string : string + SelectCountryActivity.SPLITTER + c;
                        long currentTimeMillis2 = System.currentTimeMillis() / 1000;
                        String G = l.G(context);
                        ContentValues contentValues2 = new ContentValues();
                        contentValues2.put(ParamKey.UID, r.q(str2));
