...
public class ShareRequestParam extends BrowserRequestParamBase {
    ...
    public String buildUrl(String str) {
        StringBuilder stringBuilder = new StringBuilder(SHARE_URL);
        stringBuilder.append("?").append("title").append("=").append(this.mShareContent);
        ...
        if (!TextUtils.isEmpty(str)) {
            stringBuilder.append("&").append(REQ_PARAM_PICINFO).append("=").append(str);
        }
