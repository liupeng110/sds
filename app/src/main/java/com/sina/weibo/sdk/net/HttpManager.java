                ...
                if (str2.equals("GET")) {
                    ...
                    try {
                        ...
                        if (weiboParameters.hasBinaryData()) {
                            httpPost.setHeader(HttpClientProxy.HEADER_CONTENT_TYPE, "multipart/form-data; boundary=" + BOUNDARY);
                            ...
                            if (obj == null || !(obj instanceof String)) {
                                ...
                                httpPost.setHeader(HttpClientProxy.HEADER_CONTENT_TYPE, (String) obj);
                            }
    ...
    public static String openUrl4RdirectURL(Context context, String str, String str2, WeiboParameters weiboParameters) throws WeiboException {
        ...
        try {
            ...
            try {
                ...
                int statusCode = execute.getStatusLine().getStatusCode();
                String value;
                if (statusCode == SecExceptionCode.SEC_ERROR_STA_INVALID_PARAM || statusCode == SecExceptionCode.SEC_ERROR_STA_DATA_FILE_MISMATCH) {
        ...
        synchronized (HttpManager.class) {
            ...
            if (file2.exists()) {
                ...
                try {
                    ...
                    HttpResponse execute = newHttpClient.execute(httpGet);
                    int statusCode = execute.getStatusLine().getStatusCode();
                    if (statusCode == SecExceptionCode.SEC_ERROR_STA_STORE_KEY_NOT_EXSITED) {
                    ...
                    Header firstHeader2 = execute.getFirstHeader(HttpClientProxy.HEADER_CONTENT_ENCODING);
                    if (firstHeader2 == null || firstHeader2.getValue().toLowerCase().indexOf(HttpClientProxy.CONTENT_ENCODING_GZIP) <= -1) {
