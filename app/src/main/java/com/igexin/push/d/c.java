...
public class c {
    ...
    private void d() {
        ...
        com.igexin.push.core.f.a().e().a(true);
    }
    ...
    public int a(String str) {
        ...
        this.e.c(str);
        this.b = d.passive;
        com.igexin.push.core.f.a().e().a(false);
        return 0;
    }
    ...
    public int a(String str, String str2, byte[] bArr) {
        e a = a(bArr);
        b bVar = (b) this.g.get(str);
        if (bVar == null || !com.igexin.push.core.g.o) {
            return -1;
        }
        this.h.put(str2, bVar);
        return com.igexin.push.core.f.a().e().a(str2, a);
    }
    ...
    public void a(Intent intent) {
        String stringExtra;
        String stringExtra2;
        if (intent.getAction().equals("com.igexin.sdk.action.snlrefresh") && com.igexin.push.a.k.s) {
            stringExtra = intent.getStringExtra("groupid");
            stringExtra2 = intent.getStringExtra("responseSNLAction");
            boolean z = com.igexin.push.core.g.l;
            boolean z2 = com.igexin.push.core.g.m;
            String stringExtra3 = intent.getStringExtra("branch");
            boolean a = com.igexin.push.core.a.f.a().a(System.currentTimeMillis());
            long a2 = q.a() + q.b();
            if (com.igexin.push.core.g.f.equals(stringExtra) && "open".equals(stringExtra3) && z && z2 && !a) {
                Intent intent2 = new Intent();
                intent2.setAction(stringExtra2);
                intent2.putExtra("groupid", com.igexin.push.core.g.f);
                intent2.putExtra("branch", "open");
                intent2.putExtra("pkgname", com.igexin.push.core.g.i.getPackageName());
                ...
                com.igexin.push.core.g.i.sendBroadcast(intent2);
            }
        } else if (intent.getAction().equals(com.igexin.push.core.g.W) && com.igexin.push.a.k.s) {
            stringExtra = intent.getStringExtra("groupid");
            stringExtra2 = intent.getStringExtra("branch");
            if (com.igexin.push.core.g.f.equals(stringExtra) && "open".equals(stringExtra2)) {
                i iVar = new i();
        ...
        } else if (intent.getAction().equals("com.igexin.sdk.action.snlretire") && com.igexin.push.a.k.s) {
            stringExtra = intent.getStringExtra("groupid");
            stringExtra2 = intent.getStringExtra("branch");
            if (com.igexin.push.core.g.f.equals(stringExtra) && "open".equals(stringExtra2)) {
                a aVar = new a();
        ...
        switch (h.b[this.b.ordinal()]) {
            case 1:
                switch (h.a[aVar.a.ordinal()]) {
                    case 1:
                        ...
                        if (com.igexin.push.a.k.s) {
                            intent = new Intent();
                            intent.setAction("com.igexin.sdk.action.snlrefresh");
                            intent.putExtra("groupid", com.igexin.push.core.g.f);
            ...
            case 2:
                switch (h.a[aVar.a.ordinal()]) {
                    ...
                    case 6:
                        try {
                            this.e.c().onPSNLConnected(this.a.getPackageName(), PushService.class.getName(), "", 0);
                            return;
                        } catch (Exception e3) {
                            return;
                        }
                ...
                switch (h.a[aVar.a.ordinal()]) {
                    case 3:
                        if (com.igexin.push.core.g.o) {
                            e lVar = new l();
                            lVar.a = com.igexin.push.core.g.t;
                            com.igexin.push.core.f.a().e().a("S-" + String.valueOf(com.igexin.push.core.g.t), lVar);
                            break;
                        }
                        break;
                    case 4:
    ...
    public int b(String str, String str2, byte[] bArr) {
        com.igexin.push.core.f.a().e().a(a(bArr));
        return 0;
    }
