...
public class c extends com.igexin.a.a.b.c {
    ...
    public Object a(f fVar, e eVar, Object obj) {
        ...
        if (obj instanceof b) {
            b bVar = (b) obj;
            g a2 = a(bVar.b > (byte) 0 ? 1 : 0, bVar.c);
            if (bVar.b > (byte) 0 && bVar.a > 0) {
                if ((a2.g & Downloads.STATUS_RUNNING) == 128) {
            ...
            Object obj2 = new byte[((bVar.b > (byte) 0 ? bVar.a + 3 : 0) + (a2.c + 5))];
    ...
    public com.igexin.a.a.d.a.f b(f fVar, e eVar, Object obj) {
        ...
        if (bVar.a == 0) {
            ...
            while (wrap.remaining() > 0) {
                ...
                if (bVar.d >= 8) {
                    g gVar = new g();
                    gVar.c = bVar.f[4] & MotionEventCompat.ACTION_MASK;
                    gVar.d = bVar.f[5] & MotionEventCompat.ACTION_MASK;
                    gVar.a(bVar.f[6]);
                    if (gVar.h == (byte) 48) {
                        this.g = true;
                        byte b2 = wrap.get();
                    ...
                    gVar.f = bVar.f[7] & MotionEventCompat.ACTION_MASK;
                    bVar.a(gVar.f);
                    bVar.d = 0;
                    bVar.f = null;
                    if (gVar.f > 0) {
