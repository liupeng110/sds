...
public class c {
    ...
    public String a(String str) {
        List installedPackages = g.i.getPackageManager().getInstalledPackages(64);
    ...
    public void a(Intent intent) {
        if (intent != null && intent.hasExtra(PushConsts.CMD_ACTION)) {
            ...
            if (stringExtra.equals("connected")) {
                ...
                try {
                    if (a.b() != null) {
                        a.b().onAuthenticated(g.g, "com.igexin.sdk.PushService", b, c);
                    }
                } catch (RemoteException e) {
                }
                try {
                    if (a.b() != null) {
                        g.i.unbindService(a.a());
                    }
                } catch (Exception e2) {
                }
    ...
    public void b(Intent intent) {
        if (intent.getStringExtra(PushConsts.CMD_ACTION).equals(PushConsts.ACTION_BROADCAST_REFRESHLS)) {
            ...
            try {
                Context createPackageContext = g.i.createPackageContext(stringExtra, 3);
                g.i.bindService(new Intent(createPackageContext, createPackageContext.getClassLoader().loadClass(stringExtra2)), aVar.a(), 1);
            } catch (Exception e) {
            }
        }
    }
