...
public final class DownloadProvider extends ContentProvider {
    ...
    private static final String[] c = new String[]{"_id", Downloads.COLUMN_APP_DATA, "_data", Downloads.COLUMN_MIME_TYPE, Downloads.COLUMN_VISIBILITY, Downloads.COLUMN_DESTINATION, Downloads.COLUMN_CONTROL, Downloads.COLUMN_STATUS, Downloads.COLUMN_LAST_MODIFICATION, Downloads.COLUMN_CREATE_MODIFICATION, Downloads.COLUMN_TOTAL_BYTES, Downloads.COLUMN_CURRENT_BYTES, "title", "description", Downloads.COLUMN_DATA8, Downloads.COLUMN_DATA10};
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        ...
        switch (match) {
            case 1:
            case 2:
                r1 = str != null ? match == 1 ? "( " + str + " )" : "( " + str + " ) AND " : "";
