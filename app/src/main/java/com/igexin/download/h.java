...
public class h {
    ...
    public static a a(Context context, String str, String str2, String str3, String str4, String str5, int i, int i2) {
        ...
        a2 = a(i, file.getPath() + File.separator + str6, a, "recovery".equalsIgnoreCase(str6 + a));
        return a2 != null ? new a(a2, new FileOutputStream(a2), 0) : new a(null, null, Downloads.STATUS_FILE_ERROR);
    }
    ...
    private static String a(String str, boolean z) {
        ...
        return str2 == null ? (str == null || !str.toLowerCase().startsWith("text/")) ? z ? ".bin" : str2 : str.equalsIgnoreCase(RequestPackage.CONTENT_TYPE_TEXT) ? ".html" : z ? ".txt" : str2 : str2;
    }
    ...
    public static final boolean a(android.content.Context r11, long r12) {
        ...
        r1 = com.igexin.download.Downloads.a;	 Catch:{ Exception -> 0x0076, all -> 0x006b }
        r2 = 0;
    ...
    L_0x0028:
        ...
        r7 = com.igexin.download.Downloads.a;	 Catch:{ Exception -> 0x005c, all -> 0x0072 }
