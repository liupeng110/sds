...
public final class Downloads implements BaseColumns {
    ...
    public static boolean isStatusClientError(int i) {
        return i >= 400 && i < SecExceptionCode.SEC_ERROR_DYN_STORE;
    }

    public static boolean isStatusCompleted(int i) {
        return (i >= 200 && i < SecExceptionCode.SEC_ERROR_STA_ENC) || (i >= 400 && i < SecExceptionCode.SEC_ERROR_SIGNATRUE);
    }

    public static boolean isStatusError(int i) {
        return i >= 400 && i < SecExceptionCode.SEC_ERROR_SIGNATRUE;
    }
    ...
    public static boolean isStatusServerError(int i) {
        return i >= SecExceptionCode.SEC_ERROR_DYN_STORE && i < SecExceptionCode.SEC_ERROR_SIGNATRUE;
    }

    public static boolean isStatusSuccess(int i) {
        return i >= 200 && i < SecExceptionCode.SEC_ERROR_STA_ENC;
    }
