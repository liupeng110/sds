...
public class SManager {
    ...
    private static WorkerHander mWorker = new WorkerHander(mWorkerThread.getLooper());
    private static HandlerThread mWorkerThread = new HandlerThread("Statistic");
    private String mCacheFileDir;
    private IStrategy mStrategy;

    static class WorkerHander extends Handler {
    ...
    public void addEvent(SEvent sEvent) {
        g.c("SManager", "addEvent event: " + sEvent);
