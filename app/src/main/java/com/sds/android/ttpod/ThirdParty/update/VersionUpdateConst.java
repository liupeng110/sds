...
public final class VersionUpdateConst {
    ...
    public static final String ID_BAIDU = "280471";
    ...
    public static final String PACKAGENAME_360 = "0.0.0.0";
    public static final String PACKAGENAME_BAIDU = "0.0.0.0";
    public static final String PACKAGENAME_HIAPK = "0.0.0.0";
    public static final String PACKAGENAME_WANDOUJIA = "0.0.0.0";
    ...
    public static final int UPDATE_TENCENT_TYPE = 1004;
