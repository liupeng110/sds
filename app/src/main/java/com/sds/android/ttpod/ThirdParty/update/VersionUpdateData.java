...
public class VersionUpdateData implements Parcelable {
    ...
    public VersionUpdateData(boolean z, String str, String str2, String str3) {
        ...
        this.mDownloadUrl = "";
        this.mAppstoreInstalled = Boolean.valueOf(false);
        this.mToolName = "";
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mIsUpdateMandatory == versionUpdateData.mIsUpdateMandatory && this.mLatestVersion.equals(versionUpdateData.mLatestVersion) && this.mUpdateDescription.equals(versionUpdateData.mUpdateDescription) && this.mUpdateUrl.equals(versionUpdateData.mUpdateUrl)) {
            return true;
        }
        return false;
    }
