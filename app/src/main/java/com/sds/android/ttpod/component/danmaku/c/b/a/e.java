...
import com.sds.android.ttpod.component.danmaku.a.b;
...
public class e {
    ...
    public void a(int i, int i2, int i3, boolean z) {
        ...
        if (i4 == 0 || this.b == null || this.b.isRecycled()) {
            if (this.b != null) {
                a();
            }
            this.e = i;
            this.f = i2;
            this.b = b.a(i, i2, Config.ARGB_8888);
            if (i3 > 0) {
                this.g = i3;
    ...
    public void a(int i, int i2, int i3, int i4) {
        b();
        if (this.e > 0 && this.f > 0 && this.b != null && !this.b.isRecycled()) {
            if (this.e > i3 || this.f > i4) {
                ...
                for (int i9 = 0; i9 < i6; i9++) {
                    for (min2 = 0; min2 < i5; min2++) {
                        ...
                        Bitmap a = b.a(i7, i8, Config.ARGB_8888);
                        bitmapArr2[min2] = a;
                        if (this.g > 0) {
                            a.setDensity(this.g);
                        }
    ...
    public final boolean a(Canvas canvas, float f, float f2, Paint paint) {
        if (this.c != null) {
            for (int i = 0; i < this.c.length; i++) {
                for (int i2 = 0; i2 < this.c[i].length; i2++) {
