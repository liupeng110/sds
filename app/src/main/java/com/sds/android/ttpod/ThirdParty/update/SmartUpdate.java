...
public class SmartUpdate {
    ...
    private static UpdateInterface getUpdateInstance() {
        ...
        mUpdateInterface = (UpdateInterface) a.a("com.sds.android.ttpod.ThirdParty.update.Wandoujia");
        if (mUpdateInterface != null) {
            return mUpdateInterface;
        }
        mUpdateInterface = (UpdateInterface) a.a("com.sds.android.ttpod.ThirdParty.update.Qihoo360");
        if (mUpdateInterface != null) {
            return mUpdateInterface;
        }
        mUpdateInterface = (UpdateInterface) a.a("com.sds.android.ttpod.ThirdParty.update.HiApk");
        if (mUpdateInterface != null) {
            return mUpdateInterface;
        }
        mUpdateInterface = (UpdateInterface) a.a("com.sds.android.ttpod.ThirdParty.update.Baidu");
        if (mUpdateInterface != null) {
            return mUpdateInterface;
        }
        mUpdateInterface = (UpdateInterface) a.a("com.sds.android.ttpod.ThirdParty.update.Tencent");
        if (mUpdateInterface != null) {
            return mUpdateInterface;
        }
        mUpdateInterface = (UpdateInterface) a.a("com.sds.android.ttpod.ThirdParty.update.Anzhi");
        return mUpdateInterface;
    }
