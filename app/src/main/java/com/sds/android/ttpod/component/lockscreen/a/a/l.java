...
public class l extends a {
        ...
        if (this.y == 0) {
            ...
            if (this.a != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ((com.sds.android.ttpod.component.lockscreen.a.a.a.a) arrayList.get(i)).a(this);
                }
            }
        }
        a aVar = (a) h.get();
    ...
    public void b() {
        if (this.d != 0 || ((ArrayList) j.get()).contains(this) || ((ArrayList) k.get()).contains(this)) {
            if (this.v && this.a != null) {
                ...
                while (it.hasNext()) {
                    ((com.sds.android.ttpod.component.lockscreen.a.a.a.a) it.next()).c(this);
                }
            }
            e();
        }
    ...
    private void e() {
        ...
        if (this.v && this.a != null) {
            ...
            int size = arrayList.size();
            for (int i = 0; i < size; i++) {
                ((com.sds.android.ttpod.component.lockscreen.a.a.a.a) arrayList.get(i)).b(this);
            }
        }
        this.v = false;
        this.w = false;
            ...
            case 2:
                ...
                if (f2 < 1.0f) {
                    ...
                    if (this.a != null) {
                        ...
                        for (int i = 0; i < size; i++) {
                            ((com.sds.android.ttpod.component.lockscreen.a.a.a.a) this.a.get(i)).d(this);
                        }
                    }
                    if (this.B == 2) {
                        this.q = !this.q;
