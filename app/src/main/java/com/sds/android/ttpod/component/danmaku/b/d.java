...
public class d {
    ...
    public static void a(Canvas canvas, String str) {
        ...
        a(canvas, TitleBar.SHAREBTN_RIGHT_MARGIN, (float) (height - 50), (float) ((int) (b.measureText(str) + TitleBar.BACKBTN_LEFT_MARGIN)), (float) canvas.getHeight());
        canvas.drawText(str, TitleBar.SHAREBTN_RIGHT_MARGIN, (float) height, b);
    }
