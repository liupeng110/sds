...
public final class Action {
    ...
    public static final String DOWNLOAD_MV = buildAction("download_mv");
    ...
    public static final String MEDIA_PLAY_GROUP_CHANGE = buildAction("media_play_group_change");
    ...
    public static final String PLAY_CACHE_SAVED = buildAction("play_cache_saved");
