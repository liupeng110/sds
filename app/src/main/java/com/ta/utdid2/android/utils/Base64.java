...
public class Base64 {
    ...
    static class b extends a {
        ...
        L_0x0133:
            ...
            goto L_0x005d;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ta.utdid2.android.utils.Base64.b.a(byte[], int, int, boolean):boolean");
        }
    }
...
*/
    ...
    public static byte[] encode(byte[] bArr, int i, int i2, int i3) {
        ...
        if ($assertionsDisabled || cVar.b == i4) {
            return cVar.a;
        }
