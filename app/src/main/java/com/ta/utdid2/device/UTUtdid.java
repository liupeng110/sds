...
public class UTUtdid {
    ...
    private static final String S_GLOBAL_PERSISTENT_CONFIG_DIR = ("ttpod/.UTSystemConfig" + File.separator + "Global");
    ...
    private static final String S_LOCAL_STORAGE_NAME = "ttpod/.DataStorage";
        ...
        if (isValidUTDID(str)) {
            ...
            if (str.length() == 24 && this.mTaoPC != null) {
                ...
                if (string == null || !string.equals(str)) {
                    ...
                    this.mTaoPC.putLong(IndieKitDefine.SG_KEY_INDIE_KIT_TIMESTAMP, device.getCreateTimestamp());
